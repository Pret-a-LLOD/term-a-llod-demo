...
public class Parameter {
    ...
    private String insertFileVirtuoso=TEMPLATE_PATH+"linkData.txt";
    private String insertFileRdf=TEMPLATE_PATH+"linkData.txt";
    ...
    private void setParameter(String[] args) {
        ...
        if (args.length > 4) {
            insertFileVirtuoso = args[4];
            //System.out.println("insertFile: " + insertFileVirtuoso);
        }
        if (args.length > 5) {
