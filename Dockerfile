...
RUN apt-get install -y bash git python-setuptools psmisc procps curl gnupg raptor2-utils apt-transport-https
...
# PHP for easyrdf
RUN apt-get install -y php7.0-cli php7.0-mbstring php7.0-mcrypt php7.0-xml
